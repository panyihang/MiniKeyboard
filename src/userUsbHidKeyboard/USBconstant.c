...
__code uint8_t SerDes[]={                                 //Serial String Descriptor
    0x64,0x03,
    'M',0x00,'I',0x00,'n',0x00,'i',0x00,'-',0x00,'K',0x00,
    'e',0x00,'y',0x00,'b',0x00,'o',0x00,'a',0x00,'r',0x00,'d',0x00,
        ' ',0x00,'M',0x00,'a',0x00,'K',0x00,'e',0x00,'b',0x00,
    'y',0x00,'[',0x00,'h',0x00,'t',0x00,'t',0x00,'p',0x00,'s',0x00,
        ':',0x00,'/',0x00,'/',0x00,'o',0x00,'s',0x00,'h',0x00,
    'w',0x00,'h',0x00,'u',0x00,'b',0x00,'.',0x00,'c',0x00,'o',0x00,\
        'm',0x00,'/',0x00,'a',0x00,'n',0x00,'_',0x00,'y',0x00,
    'e',0x00,']',0x00
};
...
__code uint8_t Manuf_Des[]={
    0x10,0x03,
    'A',0x00,'n',0x00,'-',0x00,'y',0x00,'e',0x00
};
